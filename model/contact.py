...
class Contact:
    ...
    def __repr__(self):
        return "%s:%s;%s;%s;%s;%s;%s;%s;%s;%s;%s" % (self.id, self.firstname, self.lastname, self.home, self.mobile, self.work, self.phone2, self.email, self.email2, self.email3, self.address)
